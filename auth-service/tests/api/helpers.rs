use auth_service::{
    ...
    services::{
        ...
        postmark_email_client::PostmarkEmailClient, RedisBannedTokenStore, RedisTwoFACodeStore,
    },
...
impl Drop for TestApp {
    fn drop(&mut self) {
        if !self.clean_up_called {
            panic!("clean_up was not called on TestApp instance before it was dropped")
        }
    }
}
